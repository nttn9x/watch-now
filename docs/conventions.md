...
- **Filename**: Use KebabCase for filenames. E.g., `product-list.component.js`.
  ...
  // component
  import ProductService from "components/[atoms | molecule]/[module-name]/[module-name].[container|component].tsx";
